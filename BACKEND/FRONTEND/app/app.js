...
const socket = io("your-backend.onrender.com");
...
createRoomForm.addEventListener("submit", async e => {
  ...
  try {
    const res = await fetch("your-backend.onrender.com/rooms", {
      method: "POST",
      headers: {
...
async function loadRooms() {
  ...
  try {
    const res = await fetch("http://your-backend.onrender.com/rooms", {
      headers: {
        "Authorization": "Bearer " + token
      }
    });
...
joinRoomBtn.addEventListener("click", async () => {
  ...
  try {
    const res = await fetch("http://your-backend.onrender.com/join-room", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "Authorization": "Bearer " + token
